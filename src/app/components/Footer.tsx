...
const Footer = () => {
  return (
    <footer className="bg-black/30 text-white py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div className="space-y-4">
            <h3 className="text-xl font-bold mb-4">DreamBee</h3>
            <p className="text-gray-400">
              Empowering creators to bring their visions to life through AI-powered scene generation.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center">
          <p className="text-gray-400">
            © {new Date().getFullYear()} DreamBee. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
